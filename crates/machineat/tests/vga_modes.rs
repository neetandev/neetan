...
use machineat::{AtBus, AtMachine, AtModel};
...
const MODE_03: ModeVector = ModeVector {
    misc: 0x67,
...
const MODE_01: ModeVector = ModeVector {
    misc: 0x67,
...
const MODE_04: ModeVector = ModeVector {
    misc: 0x63,
...
const MODE_06: ModeVector = ModeVector {
    misc: 0x63,
...
const MODE_0D: ModeVector = ModeVector {
    misc: 0x63,
...
const MODE_0E: ModeVector = ModeVector {
    misc: 0x63,
...
const MODE_0F: ModeVector = ModeVector {
    misc: 0xA2,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x06, 0x00, 0x00, 0xBC],
    crtc: [
...
const MODE_10: ModeVector = ModeVector {
    misc: 0xA3,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x06, 0x00, 0x00, 0xBC],
    crtc: [
        0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const MODE_11: ModeVector = ModeVector {
    misc: 0xE3,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x06, 0x00, 0x00, 0xBC],
    crtc: [
...
const MODE_12: ModeVector = ModeVector {
    misc: 0xE3,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x06, 0x00, 0x00, 0xBC],
    crtc: [
        0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0x0B, 0x3E, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const MODE_13: ModeVector = ModeVector {
    misc: 0x63,
...
const MODE_2F: ModeVector = ModeVector {
    misc: 0x63,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x0E, 0x00, 0x00, 0xBC],
    crtc: [
        0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const MODE_2E: ModeVector = ModeVector {
    misc: 0xE3,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x0E, 0x00, 0x00, 0xBC],
    crtc: [
        0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0x0B, 0x3E, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const MODE_30: ModeVector = ModeVector {
    misc: 0xEF,
    seq: [0x03, 0x01, 0x0F, 0x00, 0x0E, 0x00, 0x00, 0xBC],
    crtc: [
...
const PALETTE_PACKED_256: [u8; 768] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x2A, 0x00, 0x2A, 0x00, 0x00, 0x2A, 0x2A, 0x2A, 0x00, 0x00, 0x2A,
