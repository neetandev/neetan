...
impl CgromVa {
    ...
    pub fn write_row(&mut self, value: u8) {
        self.cgrow = value;
    }
    ...
    pub fn read_data(&self, font_rom: &[u8], backup_ram: &[u8], txtmode8: bool) -> u8 {
    ...
    pub fn write_data(&self, value: u8, backup_ram: &mut [u8], txtmode8: bool) {
        let hccode = self.hccode();
