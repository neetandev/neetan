...
fn create_hle_machine() -> machine_98::Pc9801Ra {
...
fn prompt_visible(machine: &machine_98::Pc9801Ra) -> bool {
    machine
        .bus
        .text_vram()
        .as_chunks::<2>()
...
fn boot_hle() -> machine_98::Pc9801Ra {
...
fn inject_and_run(machine: &mut machine_98::Pc9801Ra, code: &[u8]) {
