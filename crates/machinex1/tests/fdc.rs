...
fn select_drive(bus: &mut machinex1::X1Bus) {
...
fn program_dma(bus: &mut machinex1::X1Bus, target: u16, block_len: u16, interrupt: Option<u8>) {
...
fn program_dma_to_io(bus: &mut machinex1::X1Bus, target: u16, block_len: u16) {
    bus.io_write(DMA_PORT, 0xC3); // WR6: reset
