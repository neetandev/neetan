...
fn sio_ch1_write(bus: &mut machinex1::X1Bus, pointer: u8, value: u8) {
...
fn arm_mouse_interrupt(bus: &mut machinex1::X1Bus, vector: u8) {
...
/// report.
fn pulse_mouse_rts(bus: &mut machinex1::X1Bus) {
